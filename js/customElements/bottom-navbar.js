            ...
            <footer class="p-4 bg-white sm:p-6 dark:bg-gray-800" style="position: fixed; bottom: 0; width: 100%; overflow: hidden; background: var(--box-background-color)">
                <div class="sm:flex sm:items-center sm:justify-between">
                    ...
                    <div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                        <a href="https://www.youtube.com/c/jam54" target="_blank" class="text-gray-500 hover:text-gray-900 dark:hover:text-white transition-all">
                        ...
                        <a href="https://discord.gg/z6wEvv7" target="_blank" class="text-gray-500 hover:text-gray-900 dark:hover:text-white transition-all">
                        ...
                        <a href="https://github.com/jam53" target="_blank" class="text-gray-500 hover:text-gray-900 dark:hover:text-white transition-all">
