import jam54Logo from "../../icon.png"
...
class TopNavbar extends HTMLElement
{
    ...
    /**
     * Determines the appropriate style classes for a navigation button based on the current page and button route.
     * @param {string} buttonRoute The route this button will navigate to.
     * @return {string} The style classes to be applied to the button.
     */
